...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    <title>
      <?php echo $lang[$language][0]; echo $css->version; ?>)
    </title>
  ...
  <body>
    <div><h1 style="display:inline">
      <?php echo $lang[$language][1]; ?>
    </h1>
    <?php echo $lang[$language][2]; ?> <a
      href="http://csstidy.sourceforge.net/">csstidy</a> <?php echo $css->version; ?>)
    </div><p>
    <?php echo $lang[$language][39]; ?>: <a hreflang="en" href="?lang=en">English</a> <a hreflang="de" href="?lang=de">Deutsch</a> <a hreflang="fr" href="?lang=fr">French</a></p>
    <p><?php echo $lang[$language][4]; ?></p>
    <ul>
      <li>
      <?php echo $lang[$language][5]; ?>
      </li>
      <li>
      <?php echo $lang[$language][6]; ?>
      </li>
    </ul>
    ...
    <form method="post" action="">
      <div>
        <fieldset id="field_input">
          <legend><?php echo $lang[$language][8]; ?></legend> <label for="css_text"
          class="block"><?php echo $lang[$language][9]; ?></label><textarea id="css_text" name="css_text" rows="20" cols="35"><?php if(isset($_REQUEST['css_text'])) echo htmlspecialchars($_REQUEST['css_text']); ?></textarea>
            <label for="url"><?php echo $lang[$language][10]; ?></label> <input type="text"
          name="url" id="url" <?php if(isset($_REQUEST['url']) &&
          !empty($_REQUEST['url'])) echo 'value="'.$_REQUEST['url'].'"'; ?>
          size="35" /><br />
          <input type="submit" value="<?php echo $lang[$language][35]; ?>" id="submit" />
        </fieldset>
        <div id="rightcol">
          <fieldset id="code_layout">
            <legend><?php echo $lang[$language][11]; ?></legend> <label for="template"
            class="block"><?php echo $lang[$language][12]; ?></label> <select
         ...
         <legend><?php echo $lang[$language][19]; ?></legend>
            ...
            <label for="optimise_shorthands"><?php echo $lang[$language][23]; ?></label><br />
            ...
            <label class="help" title="<?php echo $lang[$language][34]; ?>" for="file_output">
				<strong><?php echo $lang[$language][33]; ?></strong>
			</label><br />
    ...
    style="color:red;">'.$ratio.'%</span> ('.$diff.' Bytes)';
        ...
        <?php endif;    
        echo '<fieldset><legend>'.$lang[$language][37].': '.$css->size('input').'KB, '.$lang[$language][38].':
    '.$css->size('output').'KB, '.$lang[$language][36].': '.$ratio;
        if($file_ok)
        {
    ...
    class="important">'.$lang[$language][28].'</p>';
     ?>
    <p style="text-align:center;font-size:0.8em;clear:both;">
      <a href="http://creativecommons.org/licenses/by-nc/2.0/"><img
      style="border:0;" src="cc.png" alt="Some rights reserved" width="88"
      height="31" /></a><br />
      <a href="http://creativecommons.org/licenses/by-nc/2.0/">Licensed under a
